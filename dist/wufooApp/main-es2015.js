...
let WufooFormComponent = class WufooFormComponent {
    ...
    ngOnInit() {
        this.answer = {};
        this.http.get('/api/v3/forms/zqy0v4l02nk945/fields.json').subscribe((resp) => {
...
module.exports = __webpack_require__(/*! C:\Users\drichte\Documents\wufooApp\src\main.ts */"./src/main.ts");
